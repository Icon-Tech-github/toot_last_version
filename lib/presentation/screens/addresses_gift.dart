                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                GestureDetector(
                                                    onTap: ()async{
                                                      context.read<AddressGiftCubit>().radioSelected=state.address[index].defaultAddress ==0?false:true;
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      Align(
                                                                                        ...
                                                                                        child: InkWell(
                                                                                          onTap: () {
                                                                                            FocusScope.of(context).requestFocus(FocusNode());
                                                                                            context.read<AddressGiftCubit>().editAddress(context, state.address[index].id!);
                                                                                          },
                                                                                          child: Padding(
                                                                                ...
                                                                                Center(
                                                                                  child: SizedBox(
                                                                                    ...
                                                                                    child: TextFormField(
                                                                                      ...
                                                                                      onSaved: (value){
                                                                                        context.read<AddressGiftCubit>().editAddressTitle=value!;
                                                                                      },
                                                                                      validator: (value) {
                                                                                ...
                                                                                Center(
                                                                                  child: SizedBox(
                                                                                    ...
                                                                                    child: TextFormField(
                                                                                      ...
                                                                                      onSaved: (value){
                                                                                        context.read<AddressGiftCubit>().editAddressDis=value!;
                                                                                      },
                                                                                      validator: (value) {
                                                                                        if (value == null || value.isEmpty) {
                                                                                          return LocaleKeys.Required.tr();
